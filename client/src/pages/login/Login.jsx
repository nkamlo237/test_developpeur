...
export default function Login() {
  ...
  return (
    ...
    <div className="w-full px-4 py-12 sm:px-6 sm:py-16 xl:w-1/2 xl:px-8 xl:py-24">
        ...
        <form onSubmit={handleSubmit(submitHandler)} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
        <div>
    ...
    <div className="hidden md:block md:relative h-64 md:w-full sm:h-96 xl:h-full xl:w-1/2 bg-red-600 rounded-l-[200px]">
    </div>
    </section>
  )
}
